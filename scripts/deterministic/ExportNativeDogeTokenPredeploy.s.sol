...
import {NATIVE_DOGE_TOKEN_PREDEPLOY_JSON_PATH} from "./Constants.sol";
...
contract ExportNativeDogeTokenPredeploy is Configuration {
    function run() external {
        readConfig();
        _write(L2_MAX_NATIVE_DOGE_SUPPLY);
    }
